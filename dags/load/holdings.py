...
file_holdings = data_folder_path + "HoldingHistory.txt"
...
def load(conn):
    ...
    df_fact_holdings = pd.read_csv(file_holdings,
                                   names=["TradeID", "CurrentTradeID", "HH_BEFORE_QTY", "CurrentHolding"], sep="|")
    ...
    cur.execute("DROP TRIGGER tpcdi.ADD_FactHoldings;")
